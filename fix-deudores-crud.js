...
// Updated deudores page with create/edit modal
const deudores = `import { Component, OnInit, inject, ChangeDetectorRef } from '@angular/core';
...
export class DeudoresComponent implements OnInit {
  ...
  load(): void {
    ...
    this.http.get<any[]>(environment.apiUrl + '/deudores').subscribe({
      next: (d) => { this.deudores = d; this.filtrar(); this.loading = false; this.cdr.detectChanges(); },
...
console.log('Deudores OK - con agregar/editar y busqueda');
