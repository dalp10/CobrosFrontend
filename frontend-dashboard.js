...
const dashboard = `import { Component, OnInit, AfterViewInit, inject, ChangeDetectorRef, ElementRef, ViewChild } from '@angular/core';
...
console.log('Dashboard mejorado OK');

// Crear carpeta usuarios si no existe
if (!require('fs').existsSync('src/app/pages/usuarios')) {
  require('fs').mkdirSync('src/app/pages/usuarios', { recursive: true });
  console.log('Carpeta usuarios creada');
}
